package com.example.aq.ui.user.profile.placeholder;
...
{
    public static final String TAG = AchieveHolder.class.getSimpleName();
    ...
    private LogonAchievementsAdapter mComplexAdapter;
...
//        Log.i(TAG, "bind: " + getAdapterPosition());
    ...
    public AchieveHolder builder(LogonAchievementsAdapter adapter)
    {
